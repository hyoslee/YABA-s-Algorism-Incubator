...
public class HelloYaba {
	...
	public String[] eArr= {"043370", "072520", "030210", "185750", "014680", "005940", "036830", "054090", "255440", "052260", "263810", "182360", "027830",  "002810",  "123700",  "263750",  "005880",  "089010",  "004020",  "017000",  "112610",  "082920",  "096770",  "041910",  "006620",  "001750",  "097780",  "033500", "005830", "005290", "014130", "014530", "024800", "088790"};
...
//		}
		...
		for (int i = 0; i < Math.min(els.size(), 50); i++) {
			if(els.get(i).getSurplus() > 0.0) {
				System.out.print("\033[41m ");
				System.out.print("\033[0m");
			}else if(els.get(i).getSurplus() < 0.0){
			...
			if(els.get(i).getBollinger() > 80) {
				System.out.print("\033[31m");
			}else if(els.get(i).getBollinger() > 60) {
				System.out.print("\033[35m");
			}else if(els.get(i).getBollinger() < -80 && els.get(i).getIndex() > 0) {
				System.out.print("\033[34m");
			}else if(els.get(i).getBollinger() < -60 && els.get(i).getIndex() > 0) {
...
//						, els.get(i).getName().toString().trim().substring(0, Math.min(els.get(i).getName().toString().length(), 10))
				...
				outStr = outStr + String.format("%,10d%10.1f%10.1f%10.1f%10.1f"
						...
						, els.get(i).getBollinger()
						, els.get(i).getIndex());
			}else if(els.get(i).getItm().equals("123700")) {
				outStr = outStr + "\t";
				outStr = outStr + String.format("%-10s%-10s"
						, els.get(i).getItm()
//						, els.get(i).getName().toString().trim().substring(0, Math.min(els.get(i).getName().toString().length(), 10))
				...
				outStr = outStr + String.format("%,10d%10.1f%10.1f%10.1f%10.1f"
						...
						, els.get(i).getBollinger()
						, els.get(i).getIndex());
			}else if(els.get(i).getItm().equals("043370")) {
				outStr = outStr + "\t";
				outStr = outStr + String.format("%-10s%-10s"
						, els.get(i).getItm()
//						, els.get(i).getName().toString().trim().substring(0, Math.min(els.get(i).getName().toString().length(), 10))
...
//			return;
		...
		PearsonsCorrelation b_cCo = new PearsonsCorrelation();
		...
		double[] xArray = new double[jArr.length()-adj];
		double[] yArray = new double[jArr.length()-adj];
...
//						, (b1 - b_cMean.getResult())*(10000.0/b1) 
						, b_cCo.correlation(xArray, yArray)
						));
